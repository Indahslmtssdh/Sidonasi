...
<div class="container-fluid">
    ...
    <div class="box">
        <div class="box-header">
            ...
            <?php } ?>
            <?= $this->session->flashdata('pesan'); ?>
            <a href="" class="btn btn-dark mb-3" data-toggle="modal" data-target="#donasiBaruModal"><i class="fas fa-filealt"></i> Data Baru</a>
            <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <picture>
                                        ...
                                        <img src="<?= base_url('assets/img/upload/') . $d['image']; ?>" class="img-fluid img-thumbnail" style="width: 200px ;">
                                    </picture>
                                </td>
                            </tr>
                        <?php } ?>
